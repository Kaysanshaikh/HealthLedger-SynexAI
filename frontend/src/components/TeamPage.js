...
const teamMembers = [
  {
    ...
    contribution: "Kaysan is the visionary who leads the end-to-end development of HealthLedger SynexAI, architecting the integration between blockchain security and the FL. He oversees the entire system lifecycle.",
