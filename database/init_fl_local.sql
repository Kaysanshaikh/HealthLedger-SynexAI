...
-- Structured diagnostic metrics for ML training
-- Stores individual health measurements (glucose, BMI, etc.) entered by diagnostic centers
-- These become anonymized feature vectors for federated learning — no PII touches the ML pipeline
